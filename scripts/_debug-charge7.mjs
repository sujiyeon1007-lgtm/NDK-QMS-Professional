...
console.log("before master add, store count", getTitanDataEngine().equipment.list().length, "lots", getChargeableLots("ION-01").length);
stageMasterAdd("companies", { name: COMPANY, code: "GP0TC" });
console.log("after company add, store count", getTitanDataEngine().equipment.list().length, "lots", getChargeableLots("ION-01").length);
...
console.log("after product add, store count", getTitanDataEngine().equipment.list().length, "lots", getChargeableLots("ION-01").length);