...
export const TITAN_COLUMN_WIDTHS = {
  ...
  spec: { label: "규격", widthPercent: 9 },
  currentStock: { label: "현재 재고", widthPercent: 9 },
  inboundQty: { label: "입고 수량", widthPercent: 9 },
  workInputQty: { label: "작업 투입", widthPercent: 9 },
  shippedQty: { label: "출고 수량", widthPercent: 9 },
  lastIncomingDate: { label: "최종 입고일", widthPercent: 10 },
  ...
  progress: { label: "진행률", widthPercent: 8 },
