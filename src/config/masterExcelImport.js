 ...
 *   requiredKeys: string[],
 *   duplicateKey: "code" | "companyPartNo" | "none",
...
export const MASTER_EXCEL_IMPORT_CONFIG = {
  ...
  companies: {
    ...
    title: "거래처 Master",
    kicker: "기준정보관리 · 거래처 Master",
    accept: ".xlsx,.xls",
    columns: [
      { key: "code", labels: ["업체코드", "코드"], exportLabel: "업체코드", widthPercent: 10 },
      { key: "name", labels: ["업체명", "업체", "거래처"], exportLabel: "업체명", widthPercent: 16 },
      { key: "manager", labels: ["담당자"], exportLabel: "담당자", widthPercent: 10 },
      { key: "phone", labels: ["전화번호", "연락처", "전화"], exportLabel: "전화번호", widthPercent: 12 },
      { key: "mobile", labels: ["휴대전화", "휴대폰", "핸드폰"], exportLabel: "휴대전화", widthPercent: 12 },
      { key: "email", labels: ["이메일", "email"], exportLabel: "이메일", widthPercent: 16 },
      { key: "address", labels: ["주소"], exportLabel: "주소", widthPercent: 16 },
      { key: "note", labels: ["비고", "메모"], exportLabel: "비고", widthPercent: 12 },
    ],
