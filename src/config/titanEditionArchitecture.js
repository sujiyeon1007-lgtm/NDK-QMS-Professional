...
export const EDITION_SIDEBAR_MENU_IDS = {
  [TITAN_EDITION.QUALITY]: ["home", "quality", "statistics", "environment"],
...
export const EDITION_FEATURE_COMPARISON = [
  ...
  { feature: "입고관리", quality: "❌", standalone: "✅", mesConnected: "MES" },
  { feature: "출고관리", quality: "❌", standalone: "✅", mesConnected: "MES" },
