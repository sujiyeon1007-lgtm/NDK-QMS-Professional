...
/** 설비 가동 현황 통합 — 생산관리 Navigation 내부 */
...
export const PRODUCTION_CHARGING_HUB_ROUTE = OPERATION_ROUTES.equipmentStatus;
...
export const MES_ROLE_SEPARATION = {
  equipmentStatus: "공장 전체 설비 관제 + 장입 준비 · 작업 시작/종료 · LOT 확인",
  productStatus: "제품 진행현황 · LOT 추적",
  shotWork: "쇼트 전용 작업현황 · 생산 대기/설비 가동/작업일보 우회",
  productionCharging: "설비 가동 현황으로 통합",
  productionManagement: "생산 수행 허브 (생산 대기 → 설비 가동 현황 → 작업일보 → 실적)",
};

/** PM UX — LOT 생성은 생산 대기 내부 Action, 설비 가동 현황·생산일보 핵심 강조 */
export const PRODUCTION_LAUNCHER_CORE_CARD_IDS = ["production-plan", "equipment-status", "daily-report"];
