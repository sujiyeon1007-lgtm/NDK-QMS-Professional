 ...
 * Menu Freeze V1.5 FINAL — 10 sidebar menus · Launcher Hub
...
/** Menu Freeze V1.5 FINAL — Sidebar id → Hub Route */
export const REQUIRED_SIDEBAR_MENU_ROUTES = {
  ...
  qrCharging: "/qr-workflow",
  statisticsInquiry: "/statistics/production",
  masterData: "/settings",
  environment: "/environment",
};

const MENU_FREEZE_ITEM_COUNT = 10;
...
const EXPECTED_SIDEBAR_GROUP_IDS = ["home", "operations", "quality", "mes", "executive", "system"];
