...
function getSeedTasks() {
  ...
  return [
    normalizeTask({
      id: "DW-SEED-001",
      title: "검사 대기 — LOT 260703-3S1A",
      departmentId: "quality",
      assignee: "품질관리부 / 정반이 사원",
      content: "생산완료 LOT 검사 일정 확인 및 검사일지 작성",
      requestDate: today,
      dueDate: today,
      priority: "높음",
      status: "진행중",
      ...
      partNo: "H2E19655",
      material: "SNCM439",
      managementId: "SE_20260703_0006",
    }),
    normalizeTask({
      id: "DW-SEED-002",
      title: "생산 진행 — LOT 260701-3S1A",
      departmentId: "production",
      assignee: "생산관리부 / 김과장",
      content: "생산일보 등록 및 장입 LOT 작업 확인",
      requestDate: today,
      dueDate: today,
      priority: "높음",
      status: "진행중",
